        ...
        success:function (getTables) {
            ...
            getTables.forEach(tableRow => {
                ...
                if (tableRow.status_table==true) {
                    $tabSts= '<span type="button" class="badge badge-success">Available</span>';
                } else if(tableRow.status_table==false){
                    $tabSts= `<span onclick="editTable('${tableRow._id}')" type="button" class="badge badge-danger">Unavailable</span>`;
                }else{
                    ...
                    <tr>
                        ...
                        <td class="text-center py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="#" class="btn btn-info text-white" ><i class="fas fa-edit"></i></a>
